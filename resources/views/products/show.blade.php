...
@section('content')
    <div class="container-fluid mt-5">
        <div class="container mx-auto ">
            ...
            <a href="{{ route('products.edit', ['product' => $product]) }}" class="focus:outline-none text-white bg-green-700 px-5 py-3 mr-3 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Edit</a>
            <button type="button" data-modal-toggle="defaultModal" class="focus:outline-none text-white bg-red-600 px-5 py-3 mr-3 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">Delete </button>
        </div>
    </div>
    <!-- Main modal -->
        ...
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                    {{-- create link that deletes product --}}
